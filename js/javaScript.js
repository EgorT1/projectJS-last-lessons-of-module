...
const container_card = [
    { title:"HTML 5", version:"V-5", info:"Limbaj giper text", src:"img/iconHTML.png", href:"https://www.w3schools.com/html/default.asp"},
    { title:"CSS", version:"V-88.288", info:"Limbaj stilistic", src:"img/iconCSS.png", href:"https://www.w3schools.com/css/default.asp"},
    { title:"JavaScript", version:"V-22.55", info:"Limbaj de programare", src:"img/iconJS.png", href:"https://www.w3schools.com/js/default.asp"}
]



container_card.forEach(item =>{
    const divContainer = document.createElement("div"),
        img = document.createElement("img");
        img.className = "img";
        img.src = item.src;
